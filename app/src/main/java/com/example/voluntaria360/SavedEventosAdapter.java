...
public class SavedEventosAdapter extends RecyclerView.Adapter<SavedEventosAdapter.MyViewHolder> {

    Context context;
    ArrayList<Evento> eventoList;
    FirebaseFirestore db;

    public SavedEventosAdapter(Context context, ArrayList<Evento> eventoList) {
